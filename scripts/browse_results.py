...
Usage:
    python scripts/browse_results.py --model nateraw/vit-base-beans --dataset beans --split test
"""
import argparse
...
def main():
    ...
    dataset_hf, label_names = load_test_set(args.dataset, args.split, args.limit)
